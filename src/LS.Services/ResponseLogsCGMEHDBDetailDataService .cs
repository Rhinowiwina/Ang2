...
namespace LS.Services {
    public class EhdbResponseLogDetailDataService : BaseDataService<ResponseLogsCGMEHDBDetails, string> {
        ...
        public override BaseRepository<ResponseLogsCGMEHDBDetails, string> GetDefaultRepository() {
            return new ResponseLogsCGMEHDBDetailsRepository();
        }
