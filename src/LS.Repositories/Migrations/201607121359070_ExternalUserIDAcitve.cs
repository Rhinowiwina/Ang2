namespace LS.Repositories.Migrations
{
    ...
    public partial class ExternalUserIDAcitve : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.AspNetUsers", "IsExternalUserIDActive", c => c.Boolean(nullable: false));

            this.Sql("DROP PROCEDURE [dbo].[usp_GetUsers]");
            ...
            this.Sql(@"                
                ...
                BEGIN
	                ...
	                SELECT U.Id, U.FirstName, U.LastName, U.IsActive,U.UserName, R.Name, R.Rank, U.ExternalUserID
	                ...
	                GROUP BY U.Id, U.FirstName, U.LastName, U.IsActive, U.Username, R.Name, R.Rank, U.ExternalUserID
        ...
        {
            DropColumn("dbo.AspNetUsers", "IsExternalUserIDActive");
        }
    }
}
