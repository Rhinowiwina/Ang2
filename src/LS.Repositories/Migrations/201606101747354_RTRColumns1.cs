namespace LS.Repositories.Migrations
{
    ...
    public partial class RTRColumns1 : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Orders", "RTR_RejectCode", c => c.String(maxLength: 50));
            AddColumn("dbo.Orders", "RTR_Notes", c => c.String(maxLength: 300));
            ...
            this.Sql(@"
                ...
                BEGIN
	                ...
	                [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators],[RTR_Name],[RTR_Date],[RTR_Notes],[RTR_RejectCode]) 
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Orders", "RTR_Notes");
            DropColumn("dbo.Orders", "RTR_RejectCode");
        }
    }
}
