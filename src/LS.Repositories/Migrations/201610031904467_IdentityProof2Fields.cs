namespace LS.Repositories.Migrations
{
    ...
    public partial class IdentityProof2Fields : DbMigration
    {
        public override void Up()
        {
            ...
            this.Sql(@"CREATE PROCEDURE[dbo].[Temp_Order_Insert]
                    @Id[nvarchar](128),
                ...
                BEGIN
                    INSERT[dbo].[TempOrders](
							  ...
							  , [TpivCode], [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators],[AINumHouseAdult],[AINumHouseChildren],[IDProofImageID2],[IDProofImageFilename2]
							  )
            ...
            this.Sql(@"CREATE PROCEDURE [dbo].[Order_Insert]
                    @Id [nvarchar](128),
                    @CompanyId [nvarchar](128),
                    @SalesTeamId [nvarchar](128),
                    @UserId [nvarchar](128),
                ...
                BEGIN
	                ...
	                [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators],[RTR_Name],[RTR_Date],[RTR_Notes],[RTR_RejectCode],[AINumHouseAdult],[AINumHouseChildren],[OrderCode],[IDProofImageID2],[IDProofImageFilename2]) 
