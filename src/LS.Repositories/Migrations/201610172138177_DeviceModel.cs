        ...
        public override void Up()
        {
            ...
            this.Sql(@"CREATE PROCEDURE[dbo].[Temp_Order_Insert]
                ...
                BEGIN
                    INSERT[dbo].[TempOrders](
							  ...
							  , [TpivCode], [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators],[AINumHouseAdult],[AINumHouseChildren],[DeviceCompatibility],[DeviceModel]
							  )
            ...
            this.Sql(@"CREATE PROCEDURE [dbo].[Order_Insert]
                ...
                BEGIN
	                ...
	                [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators],[RTR_Name],[RTR_Date],[RTR_Notes],[RTR_RejectCode],[AINumHouseAdult],[AINumHouseChildren],[OrderCode],[DeviceCompatibility]) 
