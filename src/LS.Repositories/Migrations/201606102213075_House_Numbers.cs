namespace LS.Repositories.Migrations
{
    ...
    public partial class House_Numbers : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Orders", "AINumHouseAdult", c => c.Int(nullable: false));
            AddColumn("dbo.Orders", "AINumHouseChildren", c => c.Int(nullable: false));
            AddColumn("dbo.TempOrders", "AINumHouseAdult", c => c.Int(nullable: false));
            AddColumn("dbo.TempOrders", "AINumHouseChildren", c => c.Int(nullable: false));
            ...
            this.Sql(@"
               CREATE PROCEDURE [dbo].[Order_Insert]
                ...
                BEGIN
	                ...
	                [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators],[RTR_Name],[RTR_Date],[RTR_Notes],[RTR_RejectCode],[AINumHouseAdult],[AINumHouseChildren]) 
        ...
        {
            DropColumn("dbo.TempOrders", "AINumHouseChildren");
            DropColumn("dbo.TempOrders", "AINumHouseAdult");
            DropColumn("dbo.Orders", "AINumHouseChildren");
            DropColumn("dbo.Orders", "AINumHouseAdult");
        }
    }
}
