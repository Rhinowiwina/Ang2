namespace LS.Repositories.Migrations
{
    ...
    public partial class usp_Clear_Order_Data : DbMigration
    {
        public override void Up()
        {

            this.Sql(@"IF OBJECTPROPERTY(object_id('dbo.usp_Clear_Order_Data'), N'IsProcedure') = 1
                     DROP PROCEDURE [dbo].[usp_Clear_Order_Data]");
         
            this.Sql(@"CREATE PROCEDURE [dbo].[usp_Clear_Order_Data]
