namespace LS.Repositories.Migrations
{
    ...
    public partial class NewTPIVColumns : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Orders", "TpivRiskIndicators", c => c.String(maxLength: 300));
            AddColumn("dbo.Orders", "TpivTransactionID", c => c.String(maxLength: 128));
            AddColumn("dbo.Orders", "TpivNasScore", c => c.String(maxLength: 200));
            AddColumn("dbo.TempOrders", "TpivCode", c => c.String());
            AddColumn("dbo.TempOrders", "TpivRiskIndicators", c => c.String());
            AddColumn("dbo.TempOrders", "TpivTransactionID", c => c.String());
            AddColumn("dbo.TempOrders", "TpivNasScore", c => c.String());
            ...
            this.Sql(@"
                ...
                BEGIN
                    INSERT[dbo].[TempOrders](
							  ...
							  , [TpivCode], [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators]
							  )
            ...
            this.Sql(@"
                ...
                BEGIN
	                ...
	                [TpivNasScore], [TpivTransactionID], [TpivRiskIndicators]) 
        ...
        {
            DropColumn("dbo.TempOrders", "TpivNasScore");
            DropColumn("dbo.TempOrders", "TpivTransactionID");
            DropColumn("dbo.TempOrders", "TpivRiskIndicators");
            DropColumn("dbo.TempOrders", "TpivCode");
            DropColumn("dbo.Orders", "TpivNasScore");
            DropColumn("dbo.Orders", "TpivTransactionID");
            DropColumn("dbo.Orders", "TpivRiskIndicators");
        }
    }
}
