            ...
            try
            {
               ...
               // responseData.StatusCode = "0";
                if (responseData.StatusCode == "0") {
                    ...
                    responseData.ErrorDescription = "This customer is already enrolled with this company in the California system and cannot sign up for an additional account.";
                } else {
