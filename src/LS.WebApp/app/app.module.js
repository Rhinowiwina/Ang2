...
var Services_4 = require("./Service/Services");
var Services_5 = require("./Service/Services");
var directives_1 = require("./Shared/directives");
//Component Imports
var Accordion_1 = require("./Shared/Accordion/Accordion");
var AccordionGroup_1 = require("./Shared/Accordion/AccordionGroup");
var AccordionHeading_1 = require("./Shared/Accordion/AccordionHeading");
var AccordionToggle_1 = require("./Shared/Accordion/AccordionToggle");
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, salesGroup_Component_1.SalesGroupComponent, modifySalesGroup_Component_1.ModifySalesGroupComponent, directives_1.EmailValidator, modifyUsers_component_1.modifyUsersComponent, loginMsg_component_1.LoginMsgComponent, filters_1.YesNo, Accordion_1.Accordion, AccordionHeading_1.AccordionHeading, AccordionGroup_1.AccordionGroup, AccordionToggle_1.AccordionToggle, users_detail_component_1.UsersdetailComponent, home_component_1.HomeComponent, header_1.HeaderComponent, branding_1.BrandingComponent, users_component_1.UserComponent, modifyLoginMsg_component_1.ModifyLoginMsgComponent],
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, common_2.DatePipe, Services_1.CompanyDataService, Services_5.SalesTeamDataService, Services_4.SalesGroupDataService, Services_3.AppUserDataService, resolve_service_1.LoggedInUserResolve, global_1.Global, global_2.Constants, Services_2.MessageDataService,],
