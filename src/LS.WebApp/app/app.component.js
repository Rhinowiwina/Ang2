...
var AppComponent = (function () {
    function AppComponent(_companyDataService, _appUserDataService, _global) {
    ...
    AppComponent.prototype.GetLoggedInUser = function () {
        var _this = this;
        this._appUserDataService.getLoggedInUser().subscribe(function (loggedInUser) {
            _this.loggedInUser = loggedInUser.data;
            console.log(_this.loggedInUser);
        }, function (error) { return _this.msg = error; });
    };
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [Services_1.CompanyDataService, Services_2.AppUserDataService, global_1.Global])
], AppComponent);
